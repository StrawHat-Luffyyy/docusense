...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-32 pb-20 lg:pt-48 lg:pb-32 font-sans">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="inline-flex items-center gap-2 rounded-full border border-indigo-500/30 bg-indigo-50/50 dark:bg-indigo-500/10 px-4 py-1.5 text-sm font-medium text-indigo-700 dark:text-indigo-300 mb-8 opacity-0 animate-fade-in-up backdrop-blur-sm shadow-sm">
        ...
        <h1 className="mx-auto max-w-5xl text-5xl font-extrabold tracking-tight sm:text-7xl opacity-0 animate-fade-in-up delay-100 text-zinc-900 dark:text-white leading-tight">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 opacity-0 animate-fade-in-up delay-300">
          <Link
            href="/sign-up"
            className="group relative flex items-center gap-2 rounded-xl bg-indigo-600 px-8 py-4 text-base font-semibold text-white transition-all hover:bg-indigo-500 shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50 overflow-hidden w-full sm:w-auto justify-center"
          >
          ...
          <Link
            href="#features"
            className="flex items-center justify-center gap-2 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 px-8 py-4 text-base font-medium text-zinc-900 dark:text-white transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-800 w-full sm:w-auto"
          >
            Learn more
          </Link>
        </div>
        ...
        {/* Dashboard Preview */}
        <div className="mx-auto mt-20 max-w-6xl relative opacity-0 animate-fade-in-up delay-400 perspective-1000">
          <div className="relative rounded-2xl bg-zinc-900/5 p-2 ring-1 ring-inset ring-zinc-900/10 dark:bg-white/5 dark:ring-white/10 lg:-m-4 lg:p-4 backdrop-blur-3xl shadow-2xl">
            ...
            <div className="rounded-xl bg-white shadow-2xl ring-1 ring-zinc-900/10 dark:bg-zinc-950 dark:ring-white/10 overflow-hidden relative">
              <div className="flex h-12 items-center border-b border-zinc-200 dark:border-zinc-800 bg-zinc-100/50 dark:bg-zinc-900/50 px-4 gap-2 backdrop-blur-md">
              ...
              <div className="flex bg-white dark:bg-zinc-950/80 min-h-[500px]">
                {/* Fake Sidebar */}
                <div className="w-64 border-r border-zinc-200 dark:border-zinc-800/50 p-4 hidden md:flex flex-col gap-6 bg-zinc-50/50 dark:bg-zinc-900/20">
                  <div className="space-y-2">
                    <div className="text-xs font-semibold text-zinc-500 uppercase tracking-wider mb-3">
                      Knowledge Base
                    </div>
                    <div className="flex items-center gap-3 px-3 py-2 rounded-md bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 text-sm font-medium">
                      <Search className="h-4 w-4" />
                      Search & Chat
                    </div>
                    <div className="flex items-center gap-3 px-3 py-2 rounded-md text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800/50 text-sm transition-colors">
                ...
                {/* Fake Chat */}
                <div className="flex-1 p-6 sm:p-8 flex flex-col justify-end relative overflow-hidden bg-dot-pattern">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-[0.03] dark:opacity-[0.02] pointer-events-none">
                    <Database className="h-64 w-64 text-zinc-900 dark:text-white" />
                  </div>
                  ...
                  <div className="space-y-6 relative z-10 w-full max-w-3xl mx-auto">
                    ...
                    <div className="flex justify-end animate-fade-in-up delay-500">
                      <div className="rounded-2xl rounded-tr-sm bg-indigo-600 text-white p-5 text-sm sm:text-base shadow-md max-w-[85%] leading-relaxed font-medium">
                    ...
                    <div className="flex justify-start animate-fade-in-up delay-[600ms]">
                      <div className="rounded-2xl rounded-tl-sm bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-5 text-sm sm:text-base shadow-sm dark:shadow-none max-w-[90%] text-zinc-800 dark:text-zinc-200 leading-relaxed">
                        ...
                        <p className="mb-3">
                          Based on the{" "}
                          <span className="px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 font-mono text-xs text-zinc-700 dark:text-zinc-300">
